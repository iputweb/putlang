						...
						<form action="{{ route('barangs.store') }}" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
										...
										<input type="text" class="form-control @error('nama_barang') is-invalid @enderror" name="nama_barang"
												id="nama_barang" placeholder="Nama Barang" autocomplete="off" value="{{ old('nama_barang') }}">
										@error('nama_barang')
								...
								<div class="form-group">
										...
										<input type="harga_barang" class="form-control @error('harga_barang') is-invalid @enderror" name="harga_barang"
												id="harga_barang" placeholder="Harga Awal" autocomplete="off" value="{{ old('harga_barang') }}">
										@error('harga_barang')
												<span class="text-danger">{{ $message }}</span>
										@enderror
								</div>
								...
								<div class="form-group">
										...
										<input type="text" class="form-control @error('deskripsi_barang') is-invalid @enderror"
												name="deskripsi_barang" id="deskripsi_barang" placeholder="Deskripsi" autocomplete="off">
								...
								<div class="form-group">
										...
										<input type="file" class="form-control @error('gambar_barang') is-invalid @enderror" name="gambar_barang"
												...
												autocomplete="off" value="{{ old('gambar_barang') }}">
										@error('gambar_barang')
												<span class="text-danger">{{ $message }}</span>
										@enderror
								</div>
