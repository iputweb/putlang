		...
		<div id="wrapper">
				...
				<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
						...
						<a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('beranda') }}">
								...
								<div class="sidebar-brand-text mx-3">PutLang</div>
						</a>
						...
						@if (Auth::user()->level == 'admin')
								<li class="nav-item {{ Nav::isRoute('bdasic.inex') }}">
						...
						@if (Auth::user()->level == 'petugas')
								<li class="nav-item {{ Nav::isRoute('barang') }}">
										<a class="nav-link" href="http://localhost:8000/barangs">
												<i class="fas fa-fw fa-box"></i>
												<span>{{ __('Barang') }}</span>
										</a>
								</li>
				...
				<div id="content-wrapper" class="d-flex flex-column">
						...
						<div id="content">
								...
								<nav class="navbar navbar-expand navbar-light topbar static-top mb-4 bg-white shadow">
										...
										<!-- Topbar Search -->
										<h3 class="fw-bold d-none d-sm-inline-block form-inline ml-md-3 my-md-0 mw-100 navbar-search my-2 mr-auto">
						...
						<footer class="sticky-footer bg-white">
								<div class="container my-auto">
										<div class="copyright my-auto text-center">
												<span>Copyright &copy; Putra Pratama 2020</span>
										</div>
								</div>
						</footer>
						<!-- End of Footer -->
